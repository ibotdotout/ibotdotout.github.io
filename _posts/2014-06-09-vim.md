...
### Vim Script
7. [autocmd group](http://learnvimscriptthehardway.stevelosh.com/chapters/14.html)
...
- [Profiling Vimscript performance](http://vimcasts.org/episodes/profiling-vimscript-performance/)
- [Improving Vim's Startup Time](http://usevim.com/2012/04/18/startuptime/)
- [Profile Vim's Plugins, Generate Awesome Statistics and Optimize Vim Startup Time](https://github.com/hyiltiz/vim-plugins-profile)
...
21. [A Good Vimrc](http://dougblack.io/words/a-good-vimrc.html)
22. [THE VIM PRESENTATION](http://inside.github.io/vim-presentation/)
23. [Vim Cast](http://vimcasts.org/categories/)
24. [vim-galore - Everything you need to know about Vim.](https://github.com/mhinz/vim-galore)
25. [Converting tabs to spaces](http://vim.wikia.com/wiki/Converting_tabs_to_spaces)
