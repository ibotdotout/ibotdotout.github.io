...
## [Remark.js](https://github.com/gnab/remark) - [Example](http://remarkjs.com)
- [Getting started](https://github.com/gnab/remark/wiki#getting-started)
- [Two-column formatting](https://github.com/gnab/remark/issues/236)
- [Export to PDF](https://github.com/gnab/remark/issues/50)
- [Keynote to Remark.js](https://github.com/derickfay/key2txt/blob/master/k2remark.applescript)


## Other Markdown slide
- [reveal.js](https://github.com/hakimel/reveal.js) - [Example](http://lab.hakim.se/reveal-js/)
