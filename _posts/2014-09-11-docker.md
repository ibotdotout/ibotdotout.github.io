...
### [To see the file size of your containers](http://stackoverflow.com/a/33344280)

```sh
$ docker ps -s
```

### [SSH to docker machine](http://stackoverflow.com/a/33350931)
...
### [Fix No space left on device in default machine](https://github.com/docker/machine/issues/1779)
...
33. [Reduce Sending build context Size to Docker-Machine](https://github.com/codekitchen/dinghy/issues/19#issuecomment-151139659)
34. [Docker : Storage Patterns for Persistence](https://kvaes.wordpress.com/2016/02/11/docker-storage-patterns-for-persistence/)
