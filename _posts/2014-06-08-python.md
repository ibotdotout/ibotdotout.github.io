...
* [How to use Python's pip to download and keep the zipped files for a package?](http://stackoverflow.com/questions/7300321/how-to-use-pythons-pip-to-download-and-keep-the-zipped-files-for-a-package)

```sh
$ pip install --download-cache="/pth/to/downloaded/files" package
```

* [Embedding python in bash scripts](http://bhfsteve.blogspot.se/2014/07/embedding-python-in-bash-scripts.html)
  - [Running a python function as a bash command](http://stackoverflow.com/questions/29734394/running-a-python-function-as-a-bash-command)
  - [Embed Python in a bash script](https://gist.github.com/jiaaro/5452675)
  ...
  - [Calling a python function from bash script](http://stackoverflow.com/questions/2119702/calling-a-python-function-from-bash-script)

    ```sh
    python -c'import themodule; themodule.thefunction("boo!")'
    ```

* [How to print to stderr in Python?](http://stackoverflow.com/questions/5574702/how-to-print-to-stderr-in-python)
...
1. [O'Reilly Functional Programming in Python](http://www.oreilly.com/programming/free/files/functional-programming-python.pdf)
2. [FUNCTIONAL PROGRAMMING WITH PYTHON by BY ALEXEY KACHAYEV, 2012](http://kachayev.github.io/talks/uapycon2012/#/)
3. [Functional Programming HOWTO](https://docs.python.org/3.5/howto/functional.html)
...
8. [Stop Writing Classes](http://pyvideo.org/video/880/stop-writing-classes)
...
5. [10 awesome features of Python that you can't use because you refuse to upgrade to Python 3](https://asmeurer.github.io/python3-presentation/slides.html#1)
6. [From C++ to Python (1) - ไทย](http://thep.blogspot.com/2016/04/from-c-to-python-1.html)
6. [From C++ to Python (2) - ไทย](http://thep.blogspot.com/2016/05/from-c-to-python-2.html)
