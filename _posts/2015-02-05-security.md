...
2. [Hack Night is an open weekly training session run by the ISIS lab](https://github.com/isislab/Hack-Night)

### Penetration testing lab
3. [PENETRATION TESTING PRACTICE LAB - VULNERABLE APPS / SYSTEMS](http://www.amanhardikar.com/mindmaps/Practice.html)
3. [Vulnhub](https://www.vulnhub.com)
3. [Pentestit](https://lab.pentestit.ru)
4. [Pentesterlab exercises](https://www.pentesterlab.com/exercises/)
