...
4. [Checking UNIX Server Performance](http://www.sitepoint.com/unix-server-performance/)
5. [How do I use sudo to redirect output to a location I don't have permission to write to?](http://stackoverflow.com/questions/82256/how-do-i-use-sudo-to-redirect-output-to-a-location-i-dont-have-permission-to-wr)
6. [UNIX Disk Usage Command Examples](http://www.cyberciti.biz/faq/unix-disk-usage-command-examples/)
