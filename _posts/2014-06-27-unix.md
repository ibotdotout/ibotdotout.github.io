...
###[Timezone setting in
Linux](http://www.thegeekstuff.com/2010/09/change-timezone-in-linux/)

```sh
$ expor TZ=Asia/Bangkok date
```

### [How to cycle through reverse-i-search in
BASH?](http://unix.stackexchange.com/questions/73498/how-to-cycle-through-reverse-i-search-in-bash)
